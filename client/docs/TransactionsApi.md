...
func main() {
    ledger := "ledger001" // string | Name of the ledger.
    transactionData := *openapiclient.NewTransactionData([]openapiclient.Posting{*openapiclient.NewPosting(int32(100), "COIN", "users:002", "users:001")}) // TransactionData | 
...
func main() {
    ledger := "ledger001" // string | Name of the ledger.
    transactions := *openapiclient.NewTransactions([]openapiclient.TransactionData{*openapiclient.NewTransactionData([]openapiclient.Posting{*openapiclient.NewPosting(int32(100), "COIN", "users:002", "users:001")})}) // Transactions | 
